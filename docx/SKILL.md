...
<!--
本文件是 DOCX 操作的子模块规范，通过主 SKILL.md 调用。
...
```xml
<!-- Example of inserting a block formula between two paragraphs -->
<w:p><w:r><w:t>Here is the formula:</w:t></w:r></w:p>
<m:oMathPara>
  <m:oMath>
    <!-- The math XML generated by the script goes here -->
  </m:oMath>
</m:oMathPara>
<w:p><w:r><w:t>As seen above...</w:t></w:r></w:p>
```
